...
public class Instrucciones extends Escena {
	...
	public void iniciar() {
		...
		AnimacionFrenada animacion = new AnimacionFrenada(1000, Config.ALTO + 100, y, () -> controlActivo = true);
	...
	public void terminar() {
		...
		AnimacionFrenada animacionLineas = new AnimacionFrenada(1000, x, xfin, null);
		for (int i = 0; i < textos.length; i++) {
			lineas[i].setAnimacionX(animacionLineas);

		}
		
		//animar texto inferior y establecer la accion final de la animacion como la ejecucion del callback
		//de la escena
		AnimacionFrenada animacion = new AnimacionFrenada(1000, (float) lineas[8].getY(), Config.ALTO + 100,
